package com.flamengo.flamenguista.keyboard.fragment;
...
import com.flamengo.flamenguista.keyboard.models.BackgroundImageModel;
...
public class BackgroundFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        list.add(new BackgroundImageModel(R.drawable.bgi8, ""));
        list.add(new BackgroundImageModel(R.drawable.bgi9, ""));
        list.add(new BackgroundImageModel(R.drawable.bgi10, ""));
        list.add(new BackgroundImageModel(R.drawable.bgi12, ""));
        list.add(new BackgroundImageModel(R.drawable.bgi14, ""));
    ...
    class MyAdapter extends RecyclerView.Adapter<MyAdapter.MyHolder> {
        ...
        public void onBindViewHolder(@NonNull MyAdapter.MyHolder holder, int position) {
            int currentBG = pref.getInt(Settings.PREF_CURRENT_BACKGROUND, R.drawable.bgi3);
