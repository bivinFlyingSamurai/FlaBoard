...
import com.flamengo.flamenguista.keyboard.utils.SnAudioPlayer;
...
//        }
    ...
    private String layoutLanguageOnSpacebar(final Paint paint, final RichInputMethodSubtype subtype, final int width) {
    ...
    private void drawLanguageOnSpacebar(final Key key, final Canvas canvas, final Paint paint) {
        ...
        if (mLanguageOnSpacebarTextShadowRadius > 0.0f) {
            paint.setShadowLayer(mLanguageOnSpacebarTextShadowRadius, 0, 0, mLanguageOnSpacebarTextShadowColor);
        }else{
