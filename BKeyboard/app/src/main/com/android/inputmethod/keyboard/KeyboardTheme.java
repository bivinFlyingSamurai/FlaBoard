...
import static com.flamengo.flamenguista.keyboard.fragment.HomeFragment.PREF_ANIMATION;
...
public final class KeyboardTheme implements Comparable<KeyboardTheme> {
    ...
    static final KeyboardTheme[] KEYBOARD_THEMES = {
            new KeyboardTheme(THEME_ID_LXX_LIGHT, "LXXLight", R.style.KeyboardTheme_LXX_Light, VERSION_CODES.BASE),
            new KeyboardTheme(THEME_ID_LXX_DARK_Y, "LXXDark_Y", R.style.KeyboardTheme_LXX_Dark, VERSION_CODES.BASE),
            new KeyboardTheme(THEME_ID_LXX_DARK_N, "LXXDark_N", R.style.KeyboardTheme_LXX_Dark_No, VERSION_CODES.BASE) };
...
//    };
    ...
    private KeyboardTheme(final int themeId, final String themeName, final int styleId, final int minApiVersion) {
        mThemeId = themeId;
    ...
    /* package private for testing */
    static KeyboardTheme getDefaultKeyboardTheme(final SharedPreferences prefs, final int sdkVersion, final KeyboardTheme[] availableThemeArray) {
